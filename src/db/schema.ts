...
export const doctorsTable = pgTable("doctors", {
  ...
  clinicId: uuid("clinic_id")
    .notNull()
    .references(() => clinicsTable.id, { onDelete: "cascade" }), // Deleta todos os dados relacionados a um clinica, incluindo os médicos (deleção em cascata)

  name: text("name").notNull(),
  avatarImageUrl: text("avatar_image_url"),
  speciality: text("speciality").notNull(),
  //Utilizar o tipo numeric do postgres para representar o preço
